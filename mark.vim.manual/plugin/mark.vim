...
function! s:DefaultHighlightings()
  ...
  highlight MarkWord1  ctermbg=Blue        ctermfg=Black  guifg=#001E80 guibg=#A1B7FF
  highlight MarkWord2  ctermbg=Magenta     ctermfg=Black  guifg=#80005D guibg=#FFA1E6
  highlight MarkWord3  ctermbg=Green       ctermfg=Black  guifg=#0F8000 guibg=#ACFFA1
  highlight MarkWord4  ctermbg=Yellow      ctermfg=Black  guifg=#806000 guibg=#FFE8A1
  highlight MarkWord5  ctermbg=DarkCyan    ctermfg=Black  guifg=#420080 guibg=#D2A1FF
  highlight MarkWord6  ctermbg=DarkBlue    ctermfg=Black  guifg=#004E80 guibg=#A1DBFF
  highlight MarkWord7  ctermbg=Brown       ctermfg=Black  guifg=#803000 guibg=#FFC4A1
  highlight MarkWord8  ctermbg=Cyan        ctermfg=Black  guifg=#007F80 guibg=#A1FEFF
  highlight MarkWord9  ctermbg=DarkMagenta ctermfg=Black  guifg=#120080 guibg=#AEA1FF
  highlight MarkWord10 ctermbg=DarkGreen   ctermfg=Black  guifg=#3F8000 guibg=#D0FFA1
  highlight MarkWord11 ctermbg=Red         ctermfg=Black  guifg=#6F8000 guibg=#F3FFA1
  highlight MarkWord12 ctermbg=DarkRed     ctermfg=Black  guifg=#720080 guibg=#F5A1FF
endfunction
...
nnoremap <silent> <F4>   :<C-u>call mark#MarkCurrentWord(v:count)<CR>
